...
if __name__ == "__main__":
    usage = """python .\script.py http://localhost:5050/ \n go to your html file and find a software that will run a web server so you can open in a web server if you dont understand use google or paste this into chatgpt to explain"""
    ...
    for page_url in args:
        ...
        with open(output_filename, "w") as file:
            file.write(replace_braces(html.encode('utf-8')))
